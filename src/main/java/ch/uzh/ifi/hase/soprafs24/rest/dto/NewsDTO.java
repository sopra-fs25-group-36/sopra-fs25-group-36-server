...
public class NewsDTO {
    ...
    public void setOverallSentimentLabel(String overallSentimentLabel) { this.overallSentimentLabel = overallSentimentLabel; }
    public List<Map<String, Object>> getTickerSentiments() { return tickerSentiments; }
    public void setTickerSentiments(List<Map<String, Object>> tickerSentiments) { this.tickerSentiments = tickerSentiments; }

    // Removed static parseTickerSentiments method as NewsService's convertToDTO now handles this.
}